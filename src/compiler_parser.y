...
%token SEMI_COLON NAME NUMBER VAR_TYPE COMMA COLON HEX OP_PRODUCT_ASN OP_DIVIDE_ASN OP_MOD_ASN DOT DOUBLE FLOAT ESC_SEQ ONE_CHAR

%type <string> NAME VAR_TYPE NUMBER HEX DOUBLE FLOAT ESC_SEQ ONE_CHAR
