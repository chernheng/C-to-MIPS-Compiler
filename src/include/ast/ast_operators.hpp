            ...
            if ((type == "double" || type == "float")&& ptr == 0){
                ...
                if (context->tempVarInfo.isPtr==1){
                    if (context->tempVarInfo.type == "double"){
                        file<<"li $t1, 8"<<std::endl;
                    } else {
                        file<<"li $t1, "<<context->tempVarInfo.numBytes<<std::endl;
                    }
                    file<<"mult $t2, $t1"<<std::endl;
