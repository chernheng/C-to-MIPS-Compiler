...
FUNCTION : VAR_INT VARIABLE B_LBRACKET B_RBRACKET SCOPE
         | VARIABLE B_LBRACKET B_RBRACKET   // need to handle arguments

SCOPE : B_LCURLY PROGRAM B_RCURLY

STATEMENT : ASSIGNMENT SEMI_COLON {}

ASSIGNMENT : DECLARATION OP_EQUAL NUMBER //int x=5

DECLARATION : KW_INT VARIABLE  // int x
